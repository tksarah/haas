...
my @option_level = (
	"聞いたことがない。・・・ITC本部スキルマップの<b>『スキルレベル 0』</b>に該当",
	"名前だけ聞いたことがある。・・・ITC本部スキルマップの<b>『スキルレベル 0』</b>に該当",
	"社内研修、イベントを受けたことがある。・・・ITC本部スキルマップの<b>『スキルレベル 0』</b>に該当",
	"利用したことがある。（検証や、個別利用等可）・・・ITC本部スキルマップの<b>『スキルレベル 1』</b>に該当",
	"自力でこのツールのコードを修正できる。・・・ITC本部スキルマップの<b>『スキルレベル 2』</b>に該当",
	"自力でこのツールのコードを書ける。・・・ITC本部スキルマップの<b>『スキルレベル 3』</b>に該当"
);
