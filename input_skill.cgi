...
my @option_level = (
	...
	"名前だけ聞いたことがある。・・・本部スキルマップの<b>『スキルレベル 0』</b>に該当",
	"社内研修、イベントを受けたことがある。・・・本部スキルマップの<b>『スキルレベル 0』</b>に該当",
	"利用したことがある。（検証や、個別利用等可）・・・本部スキルマップの<b>『スキルレベル 1』</b>に該当",
	"自力でこのツールのコードを修正できる。・・・本部スキルマップの<b>『スキルレベル 2』</b>に該当",
	"自力でこのツールのコードを書ける。・・・本部スキルマップの<b>『スキルレベル 3』</b>に該当"
);
